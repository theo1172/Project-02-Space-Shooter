...
var Collision_Sound = null
var Exhaust_Sound = null
...
func get_input():
	...
	if Input.is_action_pressed("forward"):
		...
		$Exhaust.show()
		$Exhaust.play()
		Exhaust_Sound = get_node_or_null("/root/Game/Exhaust_Sound")
		if Exhaust_Sound != null:
			Exhaust_Sound.play()
...
func damage(d):
	health -= d
	Collision_Sound = get_node_or_null("/root/Game/Collision_Sound")
